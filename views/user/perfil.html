              ...
              <div class="row mt-4">
                <div class="col-lg-12">
                  <div class="card p-3">
                    <h4>Informação</h4>
                    <p class="mt-4">
                      Caríssimo seja bem-vindo ao sistema de marcação de agenda
                      para atendimento presencial no posto de identificação,
                      tens a possibilidade de marcar um dia para efetuares o
                      processo de emissão de um determinado documento, desta
                      forma evitamos filas enormes.
                    </p>

                    <p class="mt-4">
                      Tire o máximo proveito desta solução desenvolvida para
                      atender a demanda de enchentes nos postos de
                      identificação.
                    </p>
                  </div>
                </div>
